--Exec spSavingsPortfolioReportBranch '2023-08-01', '2023-08-31','3A878792-356B-4592-8BF9-260137F9061E'
...
Declare @RVS_NL_InterestCM as numeric(18,0)        
 ...
 -----------------------------------------------------        
  ...
  WHERE branch_id=@branch_id1 AND openingDate <= @endDate1 and productcode in (1,5,6)          
  and Category = 'Having Loan During Reporting Month'        
  ...
  WHERE branch_id=@branch_id1 AND openingDate = @startDate1 and productcode in (1,5,6)          
  and Category = 'Having Loan During Reporting Month'        
  ...
  AND l.branch_id = a.branch_id         
  where l.branch_id=@branch_id1 AND openingDate = @startDate1 AND l.productcode in (1,5,6)        
...
-- set @CS_Total_WithdrawalOP=@CS_Total_WithdrawalOP-@CS_Total_WithdrawalOPT    
 ...
 if (@GT_BalanceCL > @SS_Total_Balance)        
  ...
  SET @GS_Total = @GS_Total_BalanceOP + @GS_Total_BalanceCL + @GS_Total_BalanceCM + @GS_Total_WithdrawalOP + @GS_Total_WithdrawalCL + @GS_Total_WithdrawalCM + @GS_Total_InterestOP + @GS_Total_InterestCL + @GS_Total_InterestCM + @GS_Total_FineOP + @GS_Total_FineCL + @GS_Total_FineCM + @GS_Total_CustomerCL + @GS_Total_CustomerCM + @GS_Total_CustomerOP + @GS_Total_DepositCM
